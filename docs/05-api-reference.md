...
| `ContactId` | No | Dropped when it is not a readable contact. Omit it and the contact is matched from the phone number instead, when exactly one contact holds it |
